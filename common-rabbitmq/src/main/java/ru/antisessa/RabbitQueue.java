...
public class RabbitQueue {
    ...
    public static final String CREATE_CAR_ODOMETER_REQUEST = "create_car_odometer_request";
    public static final String CREATE_CAR_GAS_TANK_VOLUME_REQUEST = "create_car_gas_tank_volume_request";
    public static final String CREATE_CAR_LAST_CONSUMPTION_REQUEST = "create_car_last_consumption_request";
    public static final String CREATE_CAR_FINAL_VALIDATION_REQUEST = "create_car_final_validation_request";
    ...
    public static final String SWITCH_STATE_TO_CREATING_CAR_FINAL_VALIDATION = "switch_state_to_creating_car_final_validation";
